...
@section('section_name', 'Testimonials')
              ...
              <div class="row">
                <div class="col-lg-12 margin-tb">
                  ...
                  <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('testimonials.create') }}"> Add </a>
                  </div>
                </div>
              </div>
              ...
              <table id="small-table" class="table table-bordered">
                ...
                <tbody id="tablecontents">
                  ...
                  <tr class="row1" data-id="{{ $values->id }}">
                    ...
                    <td>{{ $values->person_name }}</td>
                    <td>{{ ($values->status == 1)? "Active" : "Not Active" }}</td>
                    <td>
                      @can('testimonials-edit')
                      <a href="{{ route('testimonials.edit',$values->id) }}" title="Edit" style="margin-right: 10px; display: inline-block;">
                        <i class="fa fa-wrench"></i>
                      </a>
                      @endcan
                      @can('testimonials-delete')
                      {!! Form::open(['method' => 'DELETE','route' => ['testimonials.destroy', $values->id],'style'=>'display:inline','onclick'=>'return confirm("Are you sure?")']) !!}
