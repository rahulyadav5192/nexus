...
@section('section_name', 'Main Banners List')
              ...
              <div class="row">
                <div class="col-lg-12 margin-tb">
                  ...
                  <div class="pull-right">
                    <a class="btn btn-success" href="{{ route('banners.create') }}"> Add New</a>
                  </div>
                </div>
              </div>
              @endcan
              ...
              <table id="small-table" class="table table-bordered">
                ...
                <tbody id="tablecontents">
                  ...
                  <tr class="row1" data-id="{{ $values->id }}">
                    ...
                    <td>{{ $values->title_en }}</td>
                    <td><img src="{{asset('uploads/banners/'.$values->image)}}" width="275px" height="145px"></td>
                    <td>{{ ($values->status == 1)? "Active" : "Not Active" }}</td>
                    <td>
                      @can('banners-edit')
                      <a href="{{ route('banners.edit',$values->id) }}" title="Edit" style="margin-right: 10px; display: inline-block;">
                        <i class="fa fa-wrench"></i>
                      </a>
                      @endcan
                      @can('banners-delete')
                      {!! Form::open(['method' => 'DELETE','route' => ['banners.destroy', $values->id],'style'=>'display:inline','onclick'=>'return confirm("Are you sure?")']) !!}
