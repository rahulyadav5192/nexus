...
@section('page_name', 'Main Solutions')
@section('section_name', 'Main Solutions List')
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ route('solutions.create') }}"> Add New</a>
                        </div>
                    </div>
                </div>
                @endcan
                  ...
                  <tbody id="tablecontents">
                    ...
                    <tr class="row1" data-id="{{ $values->id }}">
                      ...
                      <td>
                            ...
                            <a href="{{ route('solutions.edit',$values->id) }}" title="Edit" style="margin-right: 10px; display: inline-block;">
                              <i class="fa fa-wrench"></i>
                            </a>
                      
                            {!! Form::open(['method' => 'DELETE','route' => ['solutions.destroy', $values->id],'style'=>'display:inline','onclick'=>'return confirm("Are you sure?")']) !!}
