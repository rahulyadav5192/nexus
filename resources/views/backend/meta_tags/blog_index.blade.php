...
@section('section_name', 'Meta Tags List of Blogs')
                ...
                <div class="card-header p-0 pt-1">
                  <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link active" id="custom-tabs-two-profile-tab" href="{{route('meta-tags.blog')}}" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false">Blog</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="row">
                          <div class="col-lg-12 margin-tb">
                            <div class="pull-right">
                              <a class="btn btn-success" href="{{ route('meta-tags.blog.create') }}"> Add Meta Tag</a>
                            </div>
                          </div>
                        </div>
                        @endcan
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#dataTable').DataTable({
      ...
      serverSide: true,
      ajax: {
        "url": "{{route('meta-tags.blog.showTable')}}",
        "type": "GET"
      },
      columns: [{
          data: 'page_name'
