...
@section('section_name', 'Edit Meta Tags of Pages')
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                @endif
                <br/>
                {!! Form::model($data, ['method' => 'PATCH','route' => ['meta-tags.update', $data->id],'enctype'=>'multipart/form-data']) !!}
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                <strong>Page:</strong>
                                <p class="form-control-plaintext">{{ $data->page_name }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
