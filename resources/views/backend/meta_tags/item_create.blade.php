...
@section('section_name', 'Add Meta Tags For Items')
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                {!! Form::open(array('route' => 'meta-tags.item.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
                    <div class="row">
                        
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                <strong>Items:</strong>
                                {{Form::select('item', $product_items, null,['class' => 'form-control','id'=>'item','required'])}}
                                @if ($errors->has('item'))
