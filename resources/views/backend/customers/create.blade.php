...
@section('section_name', 'Add Customer')
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::email('email', null, array('placeholder' => 'Enter Email ID','class' => 'form-control', 'required')) !!}
                                @if ($errors->has('email'))
                                  <span class="invalid-feedback" role="alert">
                    ...
                    <div class="row"> 
                      <div class="col-xs-12 col-sm-12 col-md-4">
                          <div class="form-group">
                            ...
                            {!! Form::select('status', array(0 => 'Not Active', 1 => 'Active', 2 => 'Block'), 1,array('class' => 'form-control', 'required')); !!}
