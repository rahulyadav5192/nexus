...
@section('section_name', 'Main Careers List')
              ...
              <div class="row">
                <div class="col-lg-12 margin-tb">
                  ...
                  <div class="pull-right">
                    <a class="btn btn-info" href="{{ route('careers.applications') }}" style="margin-right: 10px;">
                      <i class="fas fa-file-alt"></i> View Applications
                    </a>
                    <a class="btn btn-success" href="{{ route('careers.create') }}"> Add New</a>
                  </div>
                </div>
              </div>
              @endcan
              ...
              <table id="small-table" class="table table-bordered">
                ...
                <tbody id="tablecontents">
                  ...
                  <tr class="row1" data-id="{{ $values->id }}">
                    ...
                    <td>
                      <a href="{{ route('careers.edit',$values->id) }}" title="Edit" style="margin-right: 10px; display: inline-block;">
                        <i class="fa fa-wrench"></i>
                      </a>

                      {!! Form::open(['method' => 'DELETE','route' => ['careers.destroy', $values->id],'style'=>'display:inline','onclick'=>'return confirm("Are you sure?")']) !!}
...
<script type="text/javascript">
  $(function() {
    $("#small-table").DataTable({
      columnDefs: [
        { orderable: false, targets: [0, 3] } // Disable sorting on Drag and Actions columns
      ]
    });

    // Make sure edit links are clickable - prevent sortable from interfering
    $(document).on('click', 'a[href*="careers.edit"]', function(e) {
      e.stopPropagation();
