...
<head>
  ...
  <title>PGL Logistics @yield('title')</title>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{asset('admin_theme/plugins/jqvmap/jqvmap.min.css')}}">
  <!-- Theme style -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('admin_theme/plugins/summernote/summernote-bs4.css')}}">
  <!-- Google Font: Source Sans Pro -->
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  <!-- jQuery -->
  <script src="{{asset('admin_theme/plugins/jquery/jquery.min.js')}}"></script>

  <link rel="stylesheet" href="{{asset('admin_theme/dist/css/datatables.min.css')}}">

  <link rel="stylesheet" href="{{asset('admin_theme/plugins/toastr/toastr.min.css')}}">

  <link rel="stylesheet" href="{{asset('admin_theme/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">

  <link rel="stylesheet" href="{{asset('admin_theme/dist/css/style.css')}}">
  <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/css/select2.min.css" rel="stylesheet" />
  <script src="{{asset('frontend_theme/js/jquery.barrating.min.js')}}"></script>
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <div class="wrapper">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <?php if (Auth::user()->id == 1) { ?>
              <a href="{{ route('users.edit',1) }}" class="dropdown-item" style="text-align: center;">
            ...
            <a class="dropdown-item dropdown-footer" href="{{ route('logout') }}" onclick="event.preventDefault();
              ...
              <i class="fa fa-power-off"></i> {{ __('Sign Out') }}
            </a>
    ...
    <aside class="main-sidebar elevation-4 sidebar-light-indigo">
      <!-- Brand Logo -->
      <a href="{{ url('/web-admin') }}" class="brand-link" style="text-align: center;">
        <img src="{{ asset('nexus/images/nexus-logo.webp') }}" alt="Nexus Group Holdings" class="img-responsive" style="width: 50%;">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{ asset('nexus/images/nexus-logo.webp') }}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a href="{{ url('/web-admin') }}" class="d-block">{{ Auth::user()->name }}</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('/web-admin') }}" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                @endcan
                @can('contact-social-media')
                <li class="nav-item">
                  <a href="{{route('contact-details.index')}}" class="nav-link">
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{route('product-items.index')}}" class="nav-link">
  ...
  <!-- jQuery Knob Chart -->
  <script src="{{asset('admin_theme/plugins/jquery-knob/jquery.knob.min.js')}}"></script>
  <!-- daterangepicker -->
  ...
  <script src="{{asset('admin_theme/dist/js/master_nav.js')}}"></script>
  <script src="{{asset('admin_theme/dist/js/datatables.min.js')}}"></script>
  <script src="{{asset('admin_theme/ckeditor/ckeditor.js')}}"></script>
  <script src="{{asset('admin_theme/plugins/toastr/toastr.min.js')}}"></script>
  <script src="{{asset('admin_theme/plugins/sweetalert2/sweetalert2.min.js')}}"></script>
