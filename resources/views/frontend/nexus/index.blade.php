...
@section('title', 'Nexus Group Holdings — Gold, Luxury & Global Investments')
...
/* &mdash;&rdquo; Page-level overrides &mdash;&rdquo; */
    ...
    .roadmap-parallax-bg {
      position: absolute;
      inset: 0;
      background-image: url('{{ asset('nexus/images/nexcorp-internation.webp') }}');
    ...
    .testi-parallax-bg {
      position: absolute;
      inset: 0;
      background-image: url('{{ asset('nexus/images/nexus-gold-and-diamonds.webp') }}');
      background-attachment: fixed;
      background-size: cover;
      background-position: center;
      z-index: 0
    ...
    .eco-dir-bg {
      position: absolute;
      inset: 0;
      background-image: url('{{ asset('nexus/images/bg.webp') }}');
      background-attachment: fixed;
      background-size: cover;
      background-position: center;
      z-index: 0
  ...
  <section class="hero">
    ...
    <div class="wrap">
      ...
      <div class="hero-actions reveal d3">
        <a class="btn solid" href="{{ route('companies') }}"><span>Explore Our Group</span> <span class="arr">&rarr;</span></a>
        <a class="btn ghost" href="{{ route('expansion') }}"><span>View Expansion Vision</span></a>
      </div>
    </div>
  </section>
  ...
  <section id="about">
    <div class="wrap editorial">
      ...
      <div class="col-meta reveal d2">
        ...
        <div style="margin-top:2.4rem"><a class="link-arrow" href="{{ route('about') }}">Read Our Story <span
  ...
  <section id="ecosystem">
    <div class="wrap">
      ...
      <div class="eco-grid" style="margin-top:clamp(2.5rem,5vw,4rem)">
        <a class="eco-card reveal" href="{{ route('operations') }}">
          <div class="bg"><img loading="lazy"
              src="{{ asset('nexus/images/nexcorp-internation.webp') }}"
        ...
        <a class="eco-card reveal d1" href="{{ route('operations') }}">
          <div class="bg"><img loading="lazy"
              src="{{ asset('nexus/images/nexcorp-elution.webp') }}"
        ...
        <a class="eco-card reveal d2" href="{{ route('operations') }}">
          <div class="bg"><img loading="lazy"
              src="{{ asset('nexus/images/nexus-chains-manufacturing.webp') }}"
        ...
        <a class="eco-card reveal" href="{{ route('companies') }}">
          <div class="bg"><img loading="lazy"
              src="{{ asset('nexus/images/nexus-gold-and-diamonds.webp') }}"
        ...
        <a class="eco-card reveal d1" href="{{ route('investors') }}">
          <div class="bg"><img loading="lazy"
              src="{{ asset('nexus/images/investment-divison.webp') }}"
        ...
        <a class="eco-card reveal d2" href="{{ route('companies') }}">
          <div class="bg"><img loading="lazy"
      ...
      <div class="rm-intro">
        ...
        <div class="reveal d2" style="padding-top:.6rem">
          <p style="color:var(--ink-dim);font-size:var(--fs-lead);max-width:44ch;line-height:1.7">Four deliberate phases
            ...
            listed
            group by 2030.</p>
          <a class="link-arrow" href="{{ route('expansion') }}"
  ...
  <section id="leadership">
    <div class="wrap">
      <div class="stats-head">
        ...
        <a class="btn solid reveal d2" href="{{ route('leadership') }}" style="margin-top:1rem"><span>Meet The Leadership Team</span> <span class="arr">&rarr;</span></a>
      </div>

      <div class="lead-grid">
        <div class="person reveal">
          <div class="frame"><img src="{{ asset('nexus/images/al-ameen.webp') }}" alt="Portrait"></div>
          <div class="name">Al Ameen</div>
          <div class="role">CEO</div>
        </div>
        <div class="person reveal d1">
          <div class="frame"><img src="{{ asset('nexus/images/shoukathali.webp') }}" alt="Portrait"></div>
          <div class="name">Shoukath MT</div>
          <div class="role">Head of Operations UAE</div>
        </div>
        <div class="person reveal d2">
          <div class="frame"><img src="{{ asset('nexus/images/noushad-karanath.webp') }}" alt="Portrait"></div>
          <div class="name">Noushad Karanath</div>
          <div class="role">Head of Operations Africa</div>
        </div>
        <div class="person reveal d3">
          <div class="frame"><img src="{{ asset('nexus/images/kader-muneer.webp') }}" alt="Portrait"></div>
  ...
  <section class="testi-section" id="testimonials">
    ...
    <div class="wrap testi-wrap">
      ...
      <div class="testi-grid">
        ...
        <div class="testi-card reveal{{ $index > 0 ? ' d' . min($index, 2) : '' }}">
          <span class="testi-quote">&ldquo;</span>
          <p class="testi-text">{{ $testimonial->quotes }}</p>
          <div class="testi-author">
            <div class="testi-name">{{ $testimonial->person_name }}</div>
            <div class="testi-role">{{ $testimonial->designation }}</div>
          </div>
        </div>
        @endforeach
      </div>
  ...
  <section class="cta-video-band">
    ...
    <div class="wrap cta-wrap">
      ...
      <div class="reveal d3" style="display:flex;gap:1rem;flex-wrap:wrap;justify-content:center;margin-top:2.6rem">
        ...
        <a class="btn" href="{{ route('investors') }}"
