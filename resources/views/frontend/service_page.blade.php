...
<?php
// if (!isset($meta_tags)) {
    $tag            =   'Services | Pro Global Logistics';
    $decsription    =   'Explore our comprehensive logistics services including air freight, ocean freight, land freight, warehousing, customs clearance, and project handling.';
// } else {
//     $tag            =   $meta_tags->tag;
            ...
            <div class="col-lg-8 col-12 mt-4 pt-4">
                ...
                <div class="container position-absolute bottom-0 start-0 end-0 mb-4">
                    <div class="row mt-5 d-none d-md-flex">
                        ...
                        <!-- Box 2 -->
                        @if(isset($contact_details) && $contact_details && $contact_details->mobile)
                        <div class="col-lg-3 col-md-6 col-12">
