...
<?php
// if (!isset($meta_tags)) {
    $tag            =   'Careers | Pro Global Logistics';
    $decsription    =   'Join Pro Global Logistics team. Explore career opportunities in logistics and transportation. We offer a vibrant, multicultural work environment for logistics professionals.';
// } else {
//     $tag            =   $meta_tags->tag;
        ...
        <div class="container" style="z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-10">
                    <h1 class=" text-white head-1">Careers</h1>
