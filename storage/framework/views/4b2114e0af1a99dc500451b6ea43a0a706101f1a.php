...
<?php $__env->startSection('section_name', 'Blogs List'); ?>
                ...
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-success" href="<?php echo e(route('blogs.create')); ?>"> Add New</a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <table id="small-table" class="table table-bordered">
                  ...
                  <tbody id="tablecontents">
                    ...
                    <tr class="row1" data-id="<?php echo e($values->id); ?>">
                      ...
                      <td><?php echo e($values->blog_name); ?></td>
                      <td><?php echo e(($values->status == 1)? "Active" : "Not Active"); ?></td>
                      <td><a href="<?php echo e(route('blogs.sections',$values->id)); ?>" title="Edit"><i class="fa fa-server"></i></a></td>
                      <td>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blogs-edit')): ?>
                            <a href="<?php echo e(route('blogs.edit',$values->id)); ?>" title="Edit" style="margin-right: 10px; display: inline-block;">
                              <i class="fa fa-wrench"></i>
                            </a>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blogs-delete')): ?>
                            <?php echo Form::open(['method' => 'DELETE','route' => ['blogs.destroy', $values->id],'style'=>'display:inline','onclick'=>'return confirm("Are you sure?")']); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nexus/resources/views/backend/blogs/index.blade.php ENDPATH**/ ?>